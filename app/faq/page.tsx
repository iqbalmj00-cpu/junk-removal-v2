                                                ...
                                                {item.hasSpecialCard && (
                                                    <div className="mt-8 border-2 border-dashed border-slate-300 bg-slate-50 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-8">
                                                        ...
                                                        <Link href="/get-started" className="w-full md:w-auto">
                                                            <Button data-track="book_now" className="w-full md:w-auto bg-brand-orange hover:bg-orange-600 text-white font-bold px-8 py-4 text-lg h-auto rounded-full shadow-lg">
