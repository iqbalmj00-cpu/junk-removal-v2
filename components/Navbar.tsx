                ...
                <div className="flex h-28 items-center justify-between">
                    ...
                    <div className="hidden lg:block">
                        <Link href="/get-started">
                            <Button data-track="book_now" className="bg-brand-orange hover:bg-orange-500 text-white rounded-lg shadow-lg shadow-orange-900/20 font-bold px-8 py-3 text-lg">
                    ...
                    <div className="space-y-1 px-2 pb-3 pt-2">
                        ...
                        <div className="px-3 py-2">
                            <Link href="/get-started" onClick={() => setIsMenuOpen(false)}>
                                <Button data-track="book_now" className="w-full bg-brand-orange hover:bg-orange-500 text-white rounded-lg font-bold py-3 text-lg">
                                    <Calendar className="mr-2 h-5 w-5" /> Book Now
                                </Button>
                            </Link>
                        </div>
